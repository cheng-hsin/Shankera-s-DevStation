---
title: 'AWS Route 53 - TTL'
date: 2023-06-30
lastmod: '2023-07-05'
tags: ['aws', 'route53', 'dns', 'ttl']
draft: false
summary: 'Route 53 - TTL(Time To Live) 介紹'
layout: PostSimple
...
TTL(Time To Live) 是 DNS 記錄的生命週期，當 DNS 記錄被修改時，TTL 會被重置，並且開始倒數，當 TTL 倒數到 0 時，DNS 記錄會被刷新，並且重新取得 DNS 記錄。
