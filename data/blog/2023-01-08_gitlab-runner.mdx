...
# Register a runner on EC2

If you want to register a runner on EC2, follow the steps below.

1. Install Docker on EC2
   [Install Docker on Amazon Linux 2](https://www.cyberciti.biz/faq/how-to-install-docker-on-amazon-linux-2/)
...
2. Install GitLab runner on EC2
   - [Install GitLab runner on Amazon Linux 2](https://docs.gitlab.com/runner/install/linux-repository.html)
